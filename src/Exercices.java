...
public class Exercices {
    ...
    public List exercice8(List<Integer> liste) {
        ...
        return liste.stream().map((n) -> n * 9).map((n) -> String.valueOf(n)).map((n) -> n.charAt(0))
    ...
    public List exercice9() {
         ...
         */
        List<Integer> liste = IntStream.iterate(1, (n) -> n + 1).filter((n) -> n % 3 == 0 && n % 7 == 0)
    ...
    public List exercice10() {
         ...
         */
        List<Integer> liste = IntStream.iterate(1, (n) -> n + 1).map((n) -> n * n)
